        ...
        return stream.pipe(
          postcss([
            uncss({
              ...
              ignore: [/^(\.navbar-burger).*/, /^(\.navbar-menu).*/, /^(\.navbar)\.scrolled/, /^(\.navbar)\.navbar-hidden/, /^\.fade-up/, /^\.slide-left/, /^\.pop-in/, /^\.icon-bounce/, /^\.blur-in/, /^\.tilt-in/, /^\.reveal-wipe/, /^\.visible/, /^\.hero-cascade/, /^\.animate/, /^\.repo-/, /^\.orbit/, /^\.bubble-in/, /^\.statement/, /^\.company-box/, /^\.company-featured/, /^\.current-badge/, /^\.current-company/, /^\.scroll-top/, /^\.show/, /^\.stagger/, /^\.marquee/, /^\.pill/, /^\.terminal/, /^\.output-/, /^\.prompt-/, /^\.cursor/, /^\.whoami/, /^\.about-statement/, /^\.footer-/, /^\.site-footer/, /^\.stat-/, /^\.stats-/, /^\.scroll-progress/, /^\.brand-dot/, /^\.timeline-/, /^\.tl-/, /^\.year-/],
              timeout: 100,
            }),
            autoprefixer,
            cssnano,
